...
class Todo extends Component {
 ...
 ctd(event){
   ...
   creq.open("PUT", "https://cse204.work/todos/" + s.props.id, true);
 ...
 render() {
     let tdclass = "activity";
     if (this.state.completed) {
       tdclass = "activity finish"
     }
     return (
       <article id={this.props.id} className={tdclass}>
         <button className="done" onClick={this.ctd}></button>
         <p>{this.props.text}</p>
         <button className="remove"  onClick={this.emptytodo}> Remove </button>
